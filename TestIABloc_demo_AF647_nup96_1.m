...
addpath('mex/')
addpath('../SMAP/shared/myfunctions/')
offsetfile = 'test data/ccdoffset.mat';

%% load model
modelpath = '/Volumes/Samsung_T5/EMBL files/data for PSF learning/03-10-2021 DM scan/';
...
datapath = '/Volumes/Samsung_T5/EMBL files/data for PSF learning/02-26-2021 nup96 AF647/';
...
for ii = 1:fn
    ...
    [sr] = getTrans_mac(sr,datapath1,resultfolder);
    sr.LocTransform(1:2,3,:) = sr.LocTransform(1:2,3,:)+reshape(sr.DataShift,2,1,4);
        
    
    % initial fit
    sr.Peakthresh = 10;
    [sr] = initfit_mac(sr,datapath1,resultfolder);
