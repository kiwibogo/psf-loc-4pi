...
addpath('mex\')
addpath('C:\Users\Sheng\Documents\git\SMAP\shared\myfunctions')
offsetfile = 'test data\ccdoffset.mat';

%% load model
modelpath = 'E:\EMBL files\data for PSF learning\02-18-2022 nup96 mMaple\cell3 mMaple test data\';
modelname = 'psfmodel_iter1_insitu_zernike_4pi.h5';
...
datapath = 'E:\EMBL files\data for PSF learning\02-18-2022 nup96 mMaple\';
resultfolder = [datapath,'\psf insitu fit\'];
if ~exist(resultfolder,'dir')
    mkdir(resultfolder)
end

dataname = {'cell3_nup96_mMaple_045'};
fn = length(dataname); 
